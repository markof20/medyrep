...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BlpXKL0T.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dr03-RO0.js").then((n) => n.r),
    import("./start-D0PlE2ed.js"),
...
var ROUTER_BASEPATH = "medyrep";
var SERVER_FN_BASE = "/medyrep/_serverFn/";
